...
// THIS CODE IS NOT OWNED BY ME, IT IS FROM https://www.guitarland.com/ owned by 
// Since 1997 Mike Sult / OpenMind Publishing mikesult@guitarland.com
// 
// Rhythm.js
//
 ...
 */
	export function mergeDurationsAndPitch(durations, pitches, startTime) {
		if(pitches == "")
			return undefined;
		if(startTime == undefined)
			var myStartTime = 0;
 ...
 * @returns {object} the merged data
 */
	export function mergeDurationVelocityAndPitch(durations, pitches, velocity, startTime) {
		if(pitches == "")
			return undefined;
